...
public class TblAdDimForm extends BaseForm {
	private String adId;
	...
	private FormFile sfile;
	private FormFile bfile;
	/**
	 * @return the adId
	 */
	...
	/**
	 * @param smSize the smSize to set
	 */
	...
	/**
	 * @param bgSize the bgSize to set
	 */
	...
	/**
	 * @param createUsr the createUsr to set
	 */
	 ...
	 * @return the sfile
	 */
	public FormFile getSfile() {
		return sfile;
	}
	/**
	 * @param sfile the sfile to set
	 */
	public void setSfile(FormFile sfile) {
		this.sfile = sfile;
	}
	/**
	 * @return the bfile
	 */
	public FormFile getBfile() {
		return bfile;
	}
	/**
	 * @param bfile the bfile to set
	 */
	public void setBfile(FormFile bfile) {
		this.bfile = bfile;
	}
}