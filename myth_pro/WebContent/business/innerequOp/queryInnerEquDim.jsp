...
<SCRIPT language="javascript">
	...
	function assignOnclick(){
    	...
    	form.action="<%=path%>/innerEquOp.do?method=saveInnerEquDim&outerId=" + outid+"&equlist="+equlist;
    	form.submit();
	}
</SCRIPT>
<html:form action="/innerEquOp.do">
<html:hidden property="method" value="queryInnerEquDim" />
<%
...
<div id="rightcontent">
  <div class="inner">
    ...
    <input type="button" class="btn" value="分配权限" onclick="assignOnclick();"/></span>
    </div></div>
